      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex gap-4 flex-wrap">
            ...
            <a href={import.meta.env.BASE_URL + "resume.pdf"} download="Ashik_Santhosh_Resume.pdf" target="_blank" className="px-8 py-4 rounded-full border border-slate-700 bg-slate-800/50 hover:bg-slate-700/50 hover:text-white transition-all backdrop-blur-md font-medium flex items-center gap-2">
